...
<<<<<<< HEAD
        ...
        addMonument(sharedpreferences, "Test", new int[]{R.drawable.test1, R.drawable.test2, R.drawable.test3}, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam sit amet mauris in turpis auctor aliquam euismod et eros. Praesent pulvinar neque urna, mattis vulputate elit gravida non. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas sit amet justo ipsum. Duis efficitur metus dolor, vel consectetur magna dictum eu. Suspendisse mollis dolor in ultrices varius. Nam mollis mauris non dolor varius egestas. Maecenas fringilla ornare massa, nec ultricies mi congue eu. Morbi dignissim, lacus at ornare feugiat, nisi elit vestibulum nulla, pretium iaculis sapien quam non nulla. In ac elit interdum, viverra dui quis, vestibulum libero. Cras quis ante et dolor aliquet convallis at sed tortor. Vestibulum luctus id leo sagittis viverra. Sed diam sapien, consectetur eleifend leo eu, gravida cursus ante.");
    }

	private static void addMonument(SharedPreferences sharedpreferences, String name, int [] photos, String description) {
=======
...
<<<<<<< HEAD
		MonumentList.addItem(new Monument(name, photos,captured,"IMG_20140603_201814.jpg", description));
=======
